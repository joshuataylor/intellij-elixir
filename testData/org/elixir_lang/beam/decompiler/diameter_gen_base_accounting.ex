...
defmodule :diameter_gen_base_accounting do
  ...
  def unquote(:"#get-")(unquote(:"diameter_base_accounting_E2E-Sequence")() = rec), do: [:"diameter_base_accounting_E2E-Sequence" | apply(__MODULE__, :"#get-diameter_base_accounting_E2E-Sequence", [rec])]
  ...
  def unquote(:"#get-")(attrs, unquote(:"diameter_base_accounting_E2E-Sequence")() = rec), do: apply(__MODULE__, :"#get-diameter_base_accounting_E2E-Sequence", [attrs, rec])
  ...
  def unquote(:"#get-diameter_base_accounting_E2E-Sequence")(:"AVP", rec), do: unquote(:"diameter_base_accounting_E2E-Sequence")(rec, :"AVP")
  ...
  def unquote(:"#new-")(:"diameter_base_accounting_E2E-Sequence"), do: unquote(:"diameter_base_accounting_E2E-Sequence")()
  ...
  def unquote(:"#new-diameter_base_accounting_E2E-Sequence")(vals), do: apply(__MODULE__, :"#set-diameter_base_accounting_E2E-Sequence", [vals, unquote(:"diameter_base_accounting_E2E-Sequence")()])
  ...
  def unquote(:"#set-")(vals, unquote(:"diameter_base_accounting_E2E-Sequence")() = rec), do: apply(__MODULE__, :"#set-diameter_base_accounting_E2E-Sequence", [vals, rec])
  ...
  def unquote(:"#set-diameter_base_accounting_E2E-Sequence")({:"AVP", v}, rec), do: unquote(:"diameter_base_accounting_E2E-Sequence")(rec, AVP: v)
