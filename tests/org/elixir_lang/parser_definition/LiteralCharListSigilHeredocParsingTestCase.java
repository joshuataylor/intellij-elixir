 ...
 */
public class LiteralCharListSigilHeredocParsingTestCase extends ParsingTestCase {
    ...
    protected String getTestDataPath() {
        return super.getTestDataPath() + "/literal_char_list_sigil_heredoc_parsing_test_case";
    }
}
